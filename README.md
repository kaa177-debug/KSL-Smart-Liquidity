...
- Small red/green liquidity dots and a green/red CRT diamond instead of chart text
- A five-row trade dashboard showing only liquidity status, CRT status, signal/strength, and stop loss
