...
8. **Interface:** implemented compact labels, current range, one current Stop Loss line, tiny 7-row dashboard, 16 named alert conditions, dynamic final alerts and one-label Debug Mode.
